...
export const inputVariants = cva(
    "flex w-full rounded-md bg-transparent text-sm file:border-0 file:bg-white file:text-sm file:font-medium file:text-slate-950 placeholder:text-slate-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50 dark:file:bg-slate-950 dark:file:text-slate-50 dark:placeholder:text-slate-400",
    {
        defaultVariants: {
            h: "md",
            variant: "default",

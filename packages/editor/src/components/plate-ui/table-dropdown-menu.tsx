...
import { Icons, iconVariants } from "@editor/components/icons"

import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger, useOpenState } from "./dropdown-menu"
...
export function TableDropdownMenu(props: DropdownMenuProps) {
    ...
    return (
        <DropdownMenu modal={false} {...openState} {...props}>
            ...
            <DropdownMenuContent sideOffset={0} className="flex w-[180px] min-w-0 flex-col gap-0.5" align="start">
                <DropdownMenuSub>

...
export const PopoverContent = withRef<typeof PopoverPrimitive.Content>(({ align = "center", className, sideOffset = 4, style, ...props }, ref) => (
    <PopoverPrimitive.Portal>
        <PopoverPrimitive.Content ref={ref} className={cn(popoverVariants(), className)} style={{ zIndex: 1000, ...style }} align={align} sideOffset={sideOffset} {...props} />
    </PopoverPrimitive.Portal>
))

...
export function EmojiPicker({
    ...
    return (
        <div className={cn("flex flex-col rounded-xl bg-white text-slate-950 dark:bg-slate-950 dark:text-slate-50", "h-[23rem] w-80 border border-slate-200 shadow-md dark:border-slate-800")}>

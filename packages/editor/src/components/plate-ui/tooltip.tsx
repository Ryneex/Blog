...
export const TooltipContent = withCn(
    ...
    "z-50 overflow-hidden rounded-full border bg-white px-3 py-1 text-sm text-black shadow-md",
)
...
export function withTooltip<T extends React.ComponentType<any> | keyof HTMLElementTagNameMap>(Component: T) {
    ...
    >(function ExtendComponent({ delayDuration = 0, disableHoverableContent = true, skipDelayDuration = 0, tooltip, tooltipContentProps, tooltipProps, ...props }, ref) {

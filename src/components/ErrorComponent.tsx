            ...
            <div className="flex max-w-sm flex-col items-center text-center">
                ...
                <div className="mt-6 flex w-full shrink-0 items-center gap-x-3 sm:w-auto">
                    <Button
                        ...
                        className="flex w-1/2 items-center justify-center gap-x-2 rounded-full border bg-white px-5 py-2 text-sm text-gray-700 transition-colors duration-200 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 sm:w-auto"
                    >
                    ...
                    <Button
                        ...
                        className="h-9 w-1/2 shrink-0 cursor-pointer rounded-full bg-blue-500 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 hover:bg-blue-600 dark:bg-blue-600 dark:hover:bg-blue-500 sm:w-auto"
                    >
                        Retry
                    </Button>
                </div>

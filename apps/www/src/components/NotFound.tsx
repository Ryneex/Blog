    ...
    return (
        <section className={cn("grid h-full place-items-center dark:bg-gray-900", className)}>
            <div className="flex max-w-sm flex-col items-center text-center">
                ...
                <h1 className="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">{title ?? "Page not found"}</h1>
                <p className="mt-4 text-gray-500 dark:text-gray-400">{description ?? "The page you are looking for doesn't exist. Here are some helpful links"}</p>
                {!hideButtons && (
